...
function sendMail(){
	var params = {
		name: document.getElementById("contact-your-name-6").value,
		email:  document.getElementById("contact-email-6").value,
		servicetype: document.getElementById("contact-service-6").value,
		message: document.getElementById("contact-message-6").value
	}
	const serviceID = "service_8qdt06l";
	const templateID = "template_cf6mpoz";
